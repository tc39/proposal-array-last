...
For such a common operation, it is easy to forget to `-1` from the `length` property, or to overlook it, and as such there should be a simpler syntax for doing this.
